...
var _discipleship = require("./modules/discipleship");
function init() {
    console.log("hello there!");
    (0, _discipleship.animateGather)();
}
init();

},{"../sass/main.scss":"5Izhf","./modules/discipleship":"daudB"}],"5Izhf":[function() {},{}],"daudB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "animateGather", ()=>animateGather);
var _snapsvg = require("snapsvg");
var _snapsvgDefault = parcelHelpers.interopDefault(_snapsvg);
function animateGather() {
    const icon = (0, _snapsvgDefault.default)("#Gather");
    const l = icon.select("#gatherLeft");
    (0, _snapsvgDefault.default).animate(0, 20, function(val) {
        l.attr({
            x: val
        });
    }, 1000);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","snapsvg":"fPsoO"}],"gkKU3":[function(require,module,exports) {
...
},{}],"fPsoO":[function(require,module,exports) {
// Snap.svg 0.5.0
//
...
(function(glob) {
    ...
    module.exports ? module.exports = eve : typeof define === "function" && define.amd ? define("eve", [], function() {
        return eve;
    }) : glob.eve = eve;
})(this);
(function(glob, factory) {
    ...
    define([
        ...
        var eve1 = require("eve");
        module.exports = factory(glob, eve1);
    }
})(window || this, function(window, eve2) {
    ...
    var mina1 = function(eve) {
        var animations = {}, requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(callback) {
            ...
            for(var i in animations)if (animations.hasOwnProperty(i)) {
                var a1 = animations[i], b = a1.get(), res;
                len++;
                a1.s = (b - a1.b) / (a1.dur / a1.spd);
                if (a1.s >= 1) {
                    delete animations[i];
                    a1.s = 1;
                    len--;
    ...
    \*/ mina.bounce = function(n) {
        ...
        window.mina = mina;
        return mina;
    }(typeof eve2 == "undefined" ? function() {} : eve2);
    // Copyright (c) 2013 - 2017 Adobe Systems Incorporated. All rights reserved.
    //
    // Licensed under the Apache License, Version 2.0 (the "License");
    // you may not use this file except in compliance with the License.
...
\*/ Snap.format = function() {
        ...
        function angle1(x1, y1, x2, y2, x3, y3) {
            if (x3 == null) {
                var x = x1 - x2, y = y1 - y2;
                if (!x && !y) return 0;
                return (180 + math.atan2(-y, -x) * 180 / PI + 360) % 360;
            } else return angle1(x1, y1, x3, y3) - angle1(x2, y2, x3, y3);
        }
        function rad1(deg) {
...
\*/ Snap.parsePathString = function(pathString) {
            ...
            if (!data.length) Str(pathString).replace(pathCommand, function(a, b1, c) {
                var params = [], name = b1.toLowerCase();
...
\*/ var parseTransformString = Snap.parseTransformString = function(TString) {
            ...
            if (!data.length) Str(TString).replace(tCommand, function(a, b2, c) {
                var params = [], name = b2.toLowerCase();
                c.replace(pathValues, function(a, b) {
                    b && params.push(+b);
                });
                data.push([
        ...
        function svgTransform2string(tstr) {
            ...
            tstr = tstr.replace(/(?:^|\s)(\w+)\(([^)]+)\)/g, function(all, name, params) {
                ...
                if (name == "skewX") res.push([
                    "m",
                    1,
                    0,
                    math.tan(rad1(params[0])),
                    1,
                    0,
                    0
                ]);
                else if (name == "skewY") res.push([
                    "m",
                    1,
                    math.tan(rad1(params[0])),
                    0,
    ...
    \*/ Element.prototype.attr = function(params, value) {
            ...
            if (is(params, "string")) {
                if (arguments.length > 1) {
                    ...
                    json[params] = value;
                    params = json;
                } else return eve2("snap.util.getattr." + params, el).firstDefined();
            }
            for(var att in params)if (params[has](att)) eve2("snap.util.attr." + att, el, params[att]);
            return el;
        };
        /*\
 * Snap.parse
...
\*/ Snap.plugin = function(f) {
    ...
    // See the License for the specific language governing permissions and
    // limitations under the License.
    Snap1.plugin(function(Snap, Element, Paper, glob, Fragment) {
    ...
    \*/ elproto.transform = function(tstr) {
            ...
            if (tstr == null) {
                var papa = this, global = new Snap.Matrix(this.node.getCTM()), local = extractTransform(this), ms = [
                    local
                ], m = new Snap.Matrix, i, localString = local.toTransformString(), string = Str(local) == Str(this.matrix) ? Str(_.transform) : localString;
     ...
     **
     * See @Element.append
    \*/ elproto.append = elproto.add = function(el1) {
            if (el1) {
                if (el1.type == "set") {
                    var it = this;
                ...
                el1 = wrap(el1);
                this.node.appendChild(el1.node);
                el1.paper = this.paper;
            }
            return this;
        };
        /*\
    ...
    \*/ elproto.before = function(el3) {
            ...
            el3 = wrap(el3);
            var parent1 = el3.parent();
            this.node.parentNode.insertBefore(el3.node, this.node);
            this.parent() && this.parent().add();
            parent1 && parent1.add();
            el3.paper = this.paper;
            return this;
        };
        /*\
     * Element.after
    ...
    \*/ elproto.use = function() {
        ...
        function fixids(el) {
            var els = el.selectAll("*"), it1, url = /^\s*url\(("|'|)(.*)\1\)\s*$/, ids = [], uses = {};
            ...
            for(var i = 0, ii = els.length; i < ii; i++){
                ...
                urltest(it1, "filter");
                urltest(it1, "mask");
                urltest(it1, "clip-path");
                linktest(it1);
                var oldid = $(it1.node, "id");
                if (oldid) {
                    $(it1.node, {
                        id: it1.id
                    });
            ...
            return function() {
                ...
                if (chld.length) {
                    ...
                    for(i = 0, ii = chld.length; i < ii; i++){
                        if (chld[i].nodeType == 3) res += chld[i].nodeValue;
                        else if (chld[i].nodeType == 1) res += wrap(chld[i]).toString();
                    }
                    type && (res += "</" + this.type + ">");
                } else type && (res += "/>");
                return res;
    ...
    \*/ Snap.animate = function(from, to, setter, ms, easing, callback) {
            ...
            var now = mina1.time(), anim = mina1(from, to, now, now + ms, mina1.time, setter, easing);
    ...
    \*/ elproto.animate = function(attrs, ms, easing, callback) {
            ...
            for(var key1 in attrs)if (attrs[has](key1)) {
                if (el.equal) {
                    eq = el.equal(key1, Str(attrs[key1]));
                    from = eq.from;
                    to = eq.to;
                    f = eq.f;
                } else {
                ...
                keys[key1] = slice(fkeys.length, fkeys.length + len, f);
                fkeys = fkeys.concat(from);
                tkeys = tkeys.concat(to);
            }
            var now = mina1.time(), anim = mina1(fkeys, tkeys, now, now + ms, mina1.time, function(val) {
                var attr = {};
    ...
    \*/ Snap.deurl = function(value) {
        ...
        var gradrg = /^([lr])(?:\(([^)]*)\))?(.*)$/i;
        eve2.on("snap.util.grad.parse", function parseGrad(string) {
            string = Str(string);
            ...
            len--;
            for(var i2 = 0; i2 < len; i2++)if ("offset" in stops[i2]) seed(i2, stops[i2].offset);
        ...
        eve2.on("snap.util.attr.text", function(value) {
            if (this.type == "text") {
                var i3 = 0, node = this.node, tuner = function(chunk) {
                    var out = $("tspan");
    ...
    \*/ proto.polygon = function(points) {
        ...
        \*/ function GsetStops(str) {
                ...
                if (typeof str == "string") grad = eve2("snap.util.grad.parse", null, "l(0,0,0,1)" + str).firstDefined().stops;
    ...
    // See the License for the specific language governing permissions and
    // limitations under the License.
    Snap1.plugin(function(Snap, Element, Paper, glob) {
        var elproto = Element.prototype, is1 = Snap.is, clone = Snap._.clone, has = "hasOwnProperty", p2s = /,?([a-z]),?/gi, toFloat = parseFloat, math = Math, PI = math.PI, mmin = math.min, mmax = math.max, pow = math.pow, abs = math.abs;
        function paths(ps) {
        ...
        function ellipsePath(x, y, rx, ry, a) {
            ...
            rx = +rx;
            ry = +ry;
            if (a != null) var rad = Math.PI / 180, x1 = x + rx * Math.cos(-ry * rad), x2 = x + rx * Math.cos(-a * rad), y1 = y + rx * Math.sin(-ry * rad), y2 = y + rx * Math.sin(-a * rad), res = [
                [
                    "M",
                    x1,
                    y1
        ...
        function pathToAbsolute(pathArray) {
            ...
            if (!is1(pathArray, "array") || !is1(pathArray && pathArray[0], "array")) pathArray = Snap.parsePathString(pathArray);
                ...
                if (pa0 != pa0.toUpperCase()) {
                    ...
                    switch(r[0]){
                        ...
                        case "U":
                            ...
                            r = [
                                "U"
                            ].concat(res[res.length - 1].slice(-2));
                            break;
                        case "M":
                            mx = +pa[1] + x;
                            my = +pa[2] + y;
        ...
        function a2c(x1, y1, rx, ry, angle, large_arc_flag, sweep_flag, x2, y2, recursive) {
            ...
            var _120 = PI * 120 / 180, rad2 = PI / 180 * (+angle || 0), res = [], xy, rotate = Snap._.cacher(function(x, y, rad) {
            ...
            if (!recursive) {
                xy = rotate(x1, y1, -rad2);
                x1 = xy.x;
                y1 = xy.y;
                xy = rotate(x2, y2, -rad2);
                x2 = xy.x;
                y2 = xy.y;
                var cos = math.cos(PI / 180 * angle), sin = math.sin(PI / 180 * angle), x5 = (x1 - x2) / 2, y5 = (y1 - y2) / 2;
                var h = x5 * x5 / (rx * rx) + y5 * y5 / (ry * ry);
                if (h > 1) {
                    h = math.sqrt(h);
                    rx = h * rx;
                    ry = h * ry;
                }
                var rx2 = rx * rx, ry2 = ry * ry, k = (large_arc_flag == sweep_flag ? -1 : 1) * math.sqrt(abs((rx2 * ry2 - rx2 * y5 * y5 - ry2 * x5 * x5) / (rx2 * y5 * y5 + ry2 * x5 * x5))), cx = k * rx * y5 / ry + (x1 + x2) / 2, cy = k * -ry * x5 / rx + (y1 + y2) / 2, f1 = math.asin(((y1 - cy) / ry).toFixed(9)), f2 = math.asin(((y2 - cy) / ry).toFixed(9));
                f1 = x1 < cx ? PI - f1 : f1;
                f2 = x2 < cx ? PI - f2 : f2;
                f1 < 0 && (f1 = PI * 2 + f1);
                f2 < 0 && (f2 = PI * 2 + f2);
            ...
            if (recursive) return [
                ...
                var newres = [];
                for(var i = 0, ii = res.length; i < ii; i++)newres[i] = i % 2 ? rotate(res[i - 1], res[i], rad2).y : rotate(res[i], res[i + 1], rad2).x;
                return newres;
            }
        }
        ...
        function path2curve(path3, path21) {
            var pth = !path21 && paths(path3);
            if (!path21 && pth.curve) return pathClone(pth.curve);
            var p = pathToAbsolute(path3), p2 = path21 && pathToAbsolute(path21), attrs = {
                x: 0,
                y: 0,
                bx: 0,
                by: 0,
            ...
            }, pcoms1 = [], pcoms2 = [], pfirst = "", pcom1 = ""; // holder for previous path command of original path
            for(var i5 = 0, ii = mmax(p.length, p2 && p2.length || 0); i5 < ii; i5++){
                p[i5] && (pfirst = p[i5][0]); // save current path command
                if (pfirst != "C") {
                    pcoms1[i5] = pfirst; // Save current path command
                    i5 && (pcom1 = pcoms1[i5 - 1]); // Get previous path command pcom
                }
                p[i5] = processPath(p[i5], attrs, pcom1); // Previous path command is inputted to processPath
                if (pcoms1[i5] != "A" && pfirst == "C") pcoms1[i5] = "C"; // A is the only command
                // which may produce multiple C:s
                // so we have to make sure that C is also C in original path
                fixArc(p, i5); // fixArc adds also the right amount of A:s to pcoms1
                if (p2) {
                    p2[i5] && (pfirst = p2[i5][0]);
                    if (pfirst != "C") {
                        pcoms2[i5] = pfirst;
                        i5 && (pcom1 = pcoms2[i5 - 1]);
                    }
                    p2[i5] = processPath(p2[i5], attrs2, pcom1);
                    if (pcoms2[i5] != "A" && pfirst == "C") pcoms2[i5] = "C";
                    fixArc(p2, i5);
                }
                fixM(p, p2, attrs, attrs2, i5);
                fixM(p2, p, attrs2, attrs, i5);
                var seg = p[i5], seg2 = p2 && p2[i5], seglen = seg.length, seg2len = p2 && seg2.length;
    ...
    \*/ Snap.path.isPointInsideBBox = isPointInsideBBox;
        Snap.closest = function(x, y, X, Y) {
            ...
            while(r <= 1e6 && !found){
                for(var i6 = 0, ii = X.length; i6 < ii; i6++){
                    var xy = getter(i6);
            ...
            for(i6 = 0, ii = inside.length; i6 < ii; i6++){
                var l = Snap.len(x, y, inside[i6].x, inside[i6].y);
                if (len > l) {
                    len = l;
                    inside[i6].len = l;
                    res = inside[i6];
    ...
    // limitations under the License.
    Snap1.plugin(function(Snap, Element, Paper, glob) {
        var elproto = Element.prototype, has = "hasOwnProperty", supportsTouch = "createTouch" in glob.doc, events1 = [
            "click",
            "dblclick",
            "mousedown",
            "mousemove",
     ...
     * Removes a touchcancel event handler from the element
     - handler (function) handler for the event
     = (object) @Element
    \*/ for(var i7 = events1.length; i7--;)(function(eventName) {
...
},{"eve":"fz1iv"}],"fz1iv":[function(require,module,exports) {
// Copyright (c) 2017 Adobe Systems Incorporated. All rights reserved.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
